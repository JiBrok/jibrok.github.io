...
For terms governing JiBrok apps and products, see the [EULA](/EULA/).
...
* (a) reproduce, distribute, or publicly display Website content for commercial purposes without prior written consent;
* (b) use Website content to create derivative works or competing products;
* (c) use automated tools (scrapers, bots, crawlers) to systematically extract Website content, except for standard search engine indexing.
...
"JiBrok" and JiBrok product names are trademarks of JiBrok. Atlassian, Jira, Confluence, Forge, and related names are trademarks of Atlassian. Use of any trademarks without authorization is prohibited.
...
The Website and its content are provided "as is" and "as available" without warranties of any kind, either express or implied, including but not limited to warranties of accuracy, completeness, fitness for a particular purpose, or non-infringement.

JiBrok shall not be liable for any damages arising from the use of or inability to use this Website, including but not limited to reliance on any information provided on the Website.

---

## 6. Governing Law

These Terms are governed by the laws of the Republic of Cyprus. Any disputes arising from the use of this Website shall be subject to the exclusive jurisdiction of the courts of Nicosia, Republic of Cyprus.
