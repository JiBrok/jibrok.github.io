...
1. Open application "Stopwatch field":<br>
   <ul>
      ...
      <p style="text-align: center;"><a href="/uploads/tis-cloud/open-admin-from-app-manage.webp"><img src="/uploads/tis-cloud/open-admin-from-app-manage.webp" style="width:100%" loading="lazy"></a></p>
      </li>
      <li>Or from “Apps“ menu:
      <p style="text-align: center;"><a href="/uploads/tis-cloud/open-admin-from-apps-menu.webp"><img src="/uploads/tis-cloud/open-admin-from-apps-menu.webp" style="width:100%" loading="lazy"></a></p>
      </li>
   </ul>
2. Open "Calendars" and click "Create":<br>
   <p style="text-align: center;"><a href="/uploads/tis-cloud/create-calendar-1.webp"><img src="/uploads/tis-cloud/create-calendar-1.webp" style="width:100%" loading="lazy"></a></p>
3. Enter the data in the calendar settings fields.<br>
   <p style="text-align: center;"><a href="/uploads/tis-cloud/create-calendar-cloud-1.webp"><img src="/uploads/tis-cloud/create-calendar-cloud-1.webp" style="width:100%" loading="lazy"></a></p>="width:50%"/></a></p>
...
[comment]: <> (   <p style="text-align: center;"><a href="/uploads/time-in-status/work-calendar/time-settings.webp"><img src="/uploads/time-in-status/work-calendar/time-settings.webp" style="width:50%" loading="lazy"></a></p>)
