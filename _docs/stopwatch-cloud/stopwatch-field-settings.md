...
All settings:<br>
<p style="text-align: center;"><a href="/uploads/stopwatch-cloud/stopwatch-create-field.png"><img src="/uploads/stopwatch-cloud/stopwatch-create-field.png" style="width:100%;" loading="lazy"></a></p>
