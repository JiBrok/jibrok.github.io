...
3. Go to **Atlassian Marketplace**.
    ...
    <a href="/uploads/message-field/install/atlassian-marketplace-menu.png"><img src="/uploads/message-field/install/atlassian-marketplace-menu.png" alt="open atlassian marketplace menu" width="50%"/></a>

4. Click **Find New Apps** on the menu on the left-hand side.
<a href="/uploads/message-field/install/find-new-apps-message-field.png"><img src="/uploads/message-field/install/find-new-apps-message-field.png" alt="find new apps: message field" width="100%"/></a>
...
2. Select hosting: Server or Data Center.
    ...
    <a href="/uploads/message-field/install/hosting.png"><img src="/uploads/message-field/install/hosting.png" alt="select hosting" width="100%"/></a>

3. Click **Download** at the bottom of the page.

    <a href="/uploads/message-field/install/download.png"><img src="/uploads/message-field/install/download.png" alt="click download" width="100%"/></a>
...
7. Click **Upload app**.
    ...
    <a href="/uploads/message-field/install/upload-app.png"><img src="/uploads/message-field/install/upload-app.png" alt="click upload app" width="100%"/></a>

8. Click **Choose file** and select downloading file.
 
    <a href="/uploads/message-field/install/select-downloading-app.png"><img src="/uploads/message-field/install/select-downloading-app.png" alt="select downloading app" width="50%"/></a>
