...
1. Navigate to **Administration** (<img src="/uploads/atlassian/cog_icon.png" style="width:20px" loading="lazy"> in the top panel) → **Manage apps**
2. In the left menu, find the **Message Field** section 
3. Click **All Message fields settings**

<a href="/uploads/message-field/settings-for-all-message-fields.jpg"><img src="/uploads/message-field/settings-for-all-message-fields.jpg" style="width:100%;" loading="lazy"></a>
