...
4. Click the button showing the number of enabled modules (e.g., "X of Y modules enabled") in the right column to display plugin modules
    ...
    <a href="/uploads/message-field/plugin-modules.webp" target="_blank"><img src="/uploads/message-field/plugin-modules.webp" alt="plugin modules" width="100%" loading="lazy"></a>
