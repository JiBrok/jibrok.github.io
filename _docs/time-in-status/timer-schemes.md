...
tags: [doc, server, datacenter, time-tracking, timer, field-configuration, time-in-status, performance-optimization]
---
...
* All timer Schemes are available in this interface. From here you can create, edit and delete schemes.<br>
  <p style="text-align: center;"><a href="/uploads/time-in-status/timer-schemes/timer-scheme-create.webp" target="_blank">
<img src="/uploads/time-in-status/timer-schemes/timer-scheme-create.webp" alt="timer-scheme-create screenshot" style="width:100%" loading="lazy"></a></p>
...
* Create timer scheme<br>
  <p style="text-align: center;"><a href="/uploads/time-in-status/timer-schemes/timer-schemes-all.webp" target="_blank">
<img src="/uploads/time-in-status/timer-schemes/timer-schemes-all.webp" alt="timer-schemes-all screenshot" style="width:100%" loading="lazy"></a></p>
