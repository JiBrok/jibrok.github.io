...
2. Open "Timer" fields and click "Create":<br>
   ...
   <p style="text-align: center;"><a href="/uploads/timer-cloud/step-by-step/open-timer-fields-tab.webp" target="_blank"><img src="/uploads/timer-cloud/step-by-step/open-timer-fields-tab.webp" alt="" width="100%" loading="lazy"></a></p>
