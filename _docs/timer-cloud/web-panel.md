...
tags: [doc, cloud, timer, web-panels, goal-time, countdown, sla-tracking]
---

Enables the display of "Timer" fields in the sidebar.
...
You can create multiple panels with different settings.
...
* Projects - The panel will be available for issues from the specified projects. Empty value means all projects.
* Issue types - The panel will be available for issues of the specified types. Empty value means all issue types.
