...
1. Open application "Timer field":<br>
   <ul>
      ...
      <li>Or from “Apps“ menu:
       <p style="text-align: center;"><a href="/uploads/timer-cloud/step-by-step/open-plugin-menu.webp"><img src="/uploads/timer-cloud/step-by-step/open-plugin-menu.webp" alt="" width="100%" loading="lazy"></a></p>
      </li>
   </ul>
2. Open "Web panels" tab and click "Create"

You can create many panels with different settings.
<p style="text-align: center;"><a href="/uploads/timer-cloud/web-panel-create.webp"><img src="/uploads/timer-cloud/web-panel-create.webp" loading="lazy"></a></p>
