        ...
        <div class="uk-child-width-1-2@m uk-margin-medium-top" data-uk-grid>
            ...
            <div>
                ...
                <ul class="uk-list uk-list-divider">
                    ...
                    <li>
                        <span class="uk-text-bold uk-text-primary">2020</span><br>
                        Full portfolio of Data Center/Server apps
                    </li>
                    <li>
                        <span class="uk-text-bold uk-text-primary">2021</span><br>
                        Cloud-first strategy: launched Cloud versions
                    </li>
                    <li>
                        <span class="uk-text-bold uk-text-primary">2024</span><br>
                        SOC 2 Type II certification achieved
                    </li>
                    <li>
                        <span class="uk-text-bold uk-text-primary">2025</span><br>
                        JiBrok Studio launched — Forge-native scripting platform
                    </li>
                    <li>
                        <span class="uk-text-bold uk-text-primary">2026</span><br>
                        1,000+ company installations milestone
                    </li>
                </ul>
            </div>
        </div>
